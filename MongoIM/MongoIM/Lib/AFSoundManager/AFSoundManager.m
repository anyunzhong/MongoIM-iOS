...
-(void)startPlayingLocalFileWithName:(NSURL *)fileURL andBlock:(progressBlock)block isFileChanged:(BOOL) isFileChanged{
    ...
    _timer = [NSTimer scheduledTimerWithTimeInterval:1 block:^{
        ...
        if (percentage != 100 && timeRemaining!=0) {
            //NSLog(@"888888");
...
-(void)startStreamingRemoteAudioFromURL:(NSString *)url andBlock:(progressBlock)block isFileChanged:(BOOL) isFileChanged {
